    ...
    public ArrayList<Produit> readAll() throws SQLException {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                Produit p = new Produit(id, nom, prix, categorie, marque);
                list.add(p);
            }
        } catch (SQLException e) {
            System.out.println(e);
    ...
    public Produit get(int id) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = con.prepareStatement(req)) {
            ...
            if (resultSet.next()) {
                ...
                return new Produit(id, nom, prix, categorie, marque);
            }
        }
        return null;
    }
        ...
        try {
            ...
            try (PreparedStatement preparedStatement = con.prepareStatement(query)) {
                ...
                while (resultSet.next()) {
                    ...
                    Produit p = new Produit(id, nom, prix, new Categorie(0, categorieNom), new Marque(0, marqueNom));
                    list.add(p);
                }
            }
        } catch (SQLException e) {
        ...
        try {
            ...
            try (PreparedStatement preparedStatement = con.prepareStatement(query)) {
                ...
                while (resultSet.next()) {
                    ...
                    Produit p = new Produit(id, nom, prix, new Categorie(0, categorieNom), new Marque(0, marqueName));
                    list.add(p);
                }
            }
        } catch (SQLException e) {
