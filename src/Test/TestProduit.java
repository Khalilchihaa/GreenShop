...
import Services.ProduitService.CategorieService;
import Services.ProduitService.MarqueService;
import Services.ProduitService.ProduitService;
...
//        System.out.println("Deleted Brand with ID " + brandId);
    ...
    private static void testProduitService() throws SQLException {
        ...
        // Add a product
        Produit product = new Produit("TV", 599.99, category, brand);
